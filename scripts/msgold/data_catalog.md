...
* The gold layer is the business-level data representation layer, structured to support analytical and reporting use cases. It consists of multiple fact and dimension tables for various business metrics.
...
|     rbc_(10^6/µl)_(cbc)                  |     decimal(5,   2)    |     A decimal that expresses the number of red blood cells in millions per microliter of blood.                                                                                                                        |
|     hemoglobin_(g/dl))(cbc)              |     decimal(5,   1)    |     A decimal that expresses the amount of hemoglobin protein blood, expressed in grams per deciliter.                                                                                                                 |
|     hematocrit_(%)_(cbc)                 |     decimal(5,   1)    |     A decimal that expresses the percentage of red blood cells in a person's total blood volume                                                                                                                        |
|     mch_(pg)_(cbc)                       |     decimal(5,   1)    |     A decimal that shows the average amount of hemoglobin in red blood cells (pg/cell), typically ranging from 27–33 pg                                                                                                |
|     mchc_(g/dl)_(cbc)                    |     decimal(5,   1)    |     A decimal that indicates the average concentration of hemoglobin inside the red blood cells.                                                                                                                       |
|     rdw_(%)_(cbc)                        |     decimal(5,   1)    |     A decimal that expresses the percentage of the variation in size and volume of red blood cells.                                                                                                                    |
|     platelets_(10^3/µl)_(cbc)            |     integer            |     An integer that shows the number of platelets in a microliter of blood. Expressed in thousands per microliter.                                                                                                     |
|     wbc_(10^3/µl)_(cbc)                  |     decimal(5,   2)    |     A decimal that indicates the number of leukocytes in blood expressed in thousands per microliter.                                                                                                                  |
|     neutrophils_abs_(10^3/µl)_(cbc)      |     decimal(5,   2)    |     A decimal that indicates of the number of neutrophil white blood cells in blood expressed in thousands per microliter.                                                                                             |
|     lymphocytes_abs_(10^3/µl)_(cbc)      |     decimal(5,   2)    |     A decimal that indicates the actual number of lymphocytes (a type of white blood cell) in a microliter of blood expressed in thousands per microliter.                                                             |
|     monocytes_abs_(10^3/µl)_(cbc)        |     decimal(5,   2)    |     A decimal that indicates the exact number of monocytes (a type of white blood cell) in blood expressed in thousands per microliter.                                                                                |
|     eosinophils_abs_(10^3/µl)_(cbc)      |     decimal(5,   2)    |     A decimal that indicates the number of eosinophils(a type of white blood cell) in blood expressed in thousands per microliter.                                                                                     |
|     basophils_abs_(10^3/µl)_(cbc)        |     decimal(5,   2)    |     A decimal that indicates the specific number of white blood cells in a blood expressed in thousands per microliter.                                                                                                |
|     glucose_(mg/dl)_(chem)               |     decimal(5,   1)    |     A decimal that indicates the concentration of sugar in blood express in milligrams per deciliter.                                                                                                                  |
|     bun_(mg/dl)_(chem)                   |     decimal(5,   1)    |     A decimal that indicates the amount of urea nitrogen in blood expressed milligrams per deciliter.                                                                                                                  |
|     creatinine_(mg/dl)_(chem)            |     decimal(5,   2)    |     A decimal that indicates the level of creatinine, a waste product from muscle metabolism, in the blood (serum) or urine expressed milligrams per deciliter.                                                        |
|     egfr_(ml/min/1.73m^2)_(chem)         |     decimal(5,   2)    |     A decimal that indicates how well your kidneys are filtering waste products from blood expressed in milliliters per minute per an area of 1.73 meters squared.                                                     |
|     sodium_(mEq/l)_(chem)                |     decimal(5,   1)    |     A decimal that indicates the amount of sodium (Na+) ions in blood expressed as milliequivalents per liter.                                                                                                         |
|     potassium_(mEq/l)_(chem)             |     decimal(5,   1)    |     A decimal that indicates the amount of potassium in the liquid portion (serum or plasma) of blood expressed as milliequivalents per liter.                                                                         |
|     chloride_(mEq/l)_(chem)              |     decimal(5,   1)    |     A decimal that indicates the level of chloride in the serum portion of blood expressed as milliequivalents per liter.                                                                                              |
|     total_protein_(g/dl)_(chem)          |     decimal(5,   2)    |     A decimal that indicates the total amount of albumin and globulins in blood expressed in grams per deciliter.                                                                                                      |
|     albumin_(g/dl)_(chem)                |     decimal(5,   2)    |     A decimal that indicates the main protein (albumin) produced by the liver expressed in grams per deciliter.                                                                                                        |
|     uric_acid_(mg/dl)_(chem)             |     decimal(5,   2)    |     A decimal that indicates the amount of uric acid in the blood expressed in milligrams per deciliter.                                                                                                               |
|     alt_(u/l)_(chem)                     |     decimal(5,   1)    |     A decimal that indicates the level of alanine aminotransferase enzyme in blood expressed in units per liter.                                                                                                       |
|     ast   (u/l)_(chem)                   |     decimal(5,   1)    |     A decimal that indicates measures the amount of the enzyme Aspartate aminotransferase in blood expressed in units per liter.                                                                                       |
|     ALP_(u/l)_(chem)                     |     decimal(5,   1)    |     A decimal that indicates the amount of the enzyme Alkaline Phosphatase in blood expressed in units per liter.                                                                                                      |
|     ggt_(u/l)_(chem)                     |     decimal(5,   1)    |     A decimal that indicates the amount of the gamma-glutamyl transferase enzyme in blood expressed in units per liter.                                                                                                |
|     total_bilirubin_(mg/dl)_(chem)       |     decimal(5,   2)    |     A decimal that indicates the total amount of bilirubin in the bloodstream expressed in milligrams per deciliter.                                                                                                   |
|     totalcholesterol_(mg/dl)_(lipids)    |     decimal(5,   1)    |     A decimal that indicates the amount of cholesterol and triglycerides (fatty substances) in blood expressed in milligrams per deciliter.                                                                            |
|     ldl_(mg/dl)_(lipids)                 |     decimal(5,   1)    |     A decimal that indicates fats (low-density lipoprotein) in blood expressed in milligrams per deciliter.                                                                                                            |
|     hdl_(mg/dl)_(lipids)                 |     decimal(5,   1)    |     A decimal that indicates fats (high-density lipoprotein) in blood expressed in milligrams per deciliter.                                                                                                           |
|     triglycerides_(mg/dl)_(lipids)       |     decimal(5,   1)    |     A decimal that indicates the amount of triglycerides in blood expressed in milligrams per deciliter.                                                                                                               |
|     apob_(mg/dl)_(lipids)                |     decimal(5,   1)    |     A decimal that indicates the amount of a specific protein (Apolipoprotein B-100) in your blood that carries "bad" cholesterol (LDL, VLDL, and IDL) throughout your body expressed in milligrams per deciliter.     |
